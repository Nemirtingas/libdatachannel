...
struct seed_seq_wrapper {
	std::seed_seq *seed;

	seed_seq_wrapper() { seed = random_seed(); }
	~seed_seq_wrapper() { delete seed; }
};
...
auto random_engine() {
	static thread_local seed_seq_wrapper seed_wrapper;
	static thread_local Generator engine{*seed_wrapper.seed};
